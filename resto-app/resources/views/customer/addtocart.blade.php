                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($cart_items as $item)
                                    <tr>
                                        ...
                                        <td><img src="{{ $item['ProductImage'] }}" class="img-cart" style="width: 50px; height: 50px;" alt=""></td>
                                        <td>{{ $item['ProductName'] }}</td>
                                        <td>{{ 'Rp ' . number_format($item['Total'], 0, ',', '.') }}</td>
                                        <td>
                                            <p class="quantity-text">{{ $item['Quantity'] }}</p>
                                        </td>
                                        <td class="item_price">{{ 'Rp ' . number_format($item['Total']) }}</td>
                                        <td>
                                            <form action="{{ route('cart.delete', $item['ID']) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger rounded-circle btn-tambah">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Total Harga</td>
                                    <td id="total_price">{{ 'Rp ' . number_format($totalPrice, 0, ',', '.') }}</td>
                                    <td></td>
