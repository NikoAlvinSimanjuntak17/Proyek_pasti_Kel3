  ...
  <header id="header" class="fixed-top header">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product') ? route('customer.dashboard') : '#hero' }}">Beranda</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product') ? route('customer.dashboard') : '#events' }}">Layanan</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product') ? route('customer.dashboard') : '#testimonials' }}">Feedback</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product') ? route('customer.dashboard') : '#product' }}">Produk</a></li>
                <li><a class="nav-link scrollto" href="{{ request()->routeIs('product') ? route('customer.dashboard') : '#book-a-table' }}">Reservasi</a></li>
                <li>
                    <div class="dropdown">
      ...
      <div class="d-flex p-1 me-3 nav-cart">
        <a href="{{ route('cart') }}" class="" style="position: relative;">
            <i class="bi bi-cart" style="font-size: 1.5rem;">
            </i>
        </a>
    </div>

        <img src="{{asset('users/img/profil.png')}}"  width="35px" height="35px" class="profil rounded-circle" onclick="toggleMenu()" alt="">
      <div class="sub-menu-wrap" id="subMenu">
        <div class="sub-menu">
                      ...
                      <form method="POST" action="" class="sub-menu-link">
                            @csrf
                            <img src="{{asset('users/img/logout.png')}}" alt="">
                            <a href="{{ route('logout') }}" style="margin-left:15px;">Logout</a>
