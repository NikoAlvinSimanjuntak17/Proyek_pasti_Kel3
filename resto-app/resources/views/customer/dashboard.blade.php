                          ...
                          <section id="testimonials" class="testimonials section-bg">
                            ...
                            <section id="book-a-table1" class="book-a-table">
                                <div class="container" data-aos="fade-up">
                                    ...
                                    @endif
                                    <form id="feedback-form" action="{{ route('storefeedback')}}" method="POST" class="reservasi">
                                        @csrf
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <textarea class="form-control" id="content" name="content" style="height: 150px; width: 80em;" required></textarea>
                                            </center>
                                        </div><br><br>
